...
class Dataset(Sequence):
    ...
    def set_img_include_label(self, inc_label=False):
        data=pd.read_csv("/aiffel/aiffel/C-VAE/list_attr.csv")
    ...
    def get_images(self, imgs_id, with_label=False):
        """
